...
<div class="container">
    ...
    <form class="innercontainer" method="post" action="intern_insert.php">
    	...
    	<p>Address</p>
    	<br>
    	<textarea style="margin-left: 20px; width: 90%; height: 75px;" name="address"></textarea>
    	<br>
    	<br>
    	<p>Gender</p>
    	<br>
    	...
    	<br><br>
    	<input type="submit" name="submit" style="width: 80px; height: 35px; background: #0275d8; font-weight: bold; color: white;">
